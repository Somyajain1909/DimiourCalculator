...
updateRow(key,a,b,c,d,x,f,g,h,i,j,k)
  ...
  <div className='mx-2' style={{'color':'#0E7680','fontWeight':'bolder'}}></div>
  <br/>
  <br/>
 </div>
    <div   className="input-group mb-3 ">
  ...
  &nbsp; &nbsp;Margin (input)
    ...
    <div className='mx-2' style={{'color':'#0E7680','fontWeight':'bolder','marginLeft':"2%"}}>
        Hourly $ cost
    ...
    <div className='mx-2' style={{'color':'#0E7680','fontWeight':'bolder'}}>
